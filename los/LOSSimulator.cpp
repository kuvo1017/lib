...
//======================================================================
void LOSSimulator::calcVehicleLOS(vector<Vehicle*>* vehicles){
  // これまでの車体用四分木を消去
...
//======================================================================
void LOSSimulator::field(double *xmin, double *xmax,
...
//======================================================================
void LOSSimulator::_readFiles(string shpFileName, string dbfFileName){
  // SHPファイルを開く
...
//======================================================================
void LOSSimulator::_makePolygon(int entityId, int partId, SHPObject* shape){
  assert(_hDBF);
...
//======================================================================
void LOSSimulator::_calcStraightLine(LOSVehicle* vt, LOSVehicle* vr,
				   double* a, double* b) {
